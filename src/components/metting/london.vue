...
<script>
    import Banner from "../common/londonbanner.vue"
    ...
    export default {
        data() {
            return {
                haveOne: false,
                url: "conference-london/registration",
                metTimeMsg: [],
                metPerMsg: [],
                metProjMsg: [],
                metPlauMsg: [],
        ...
        methods: {
            getUrl() {
                let that = this;
                this.$http.get(api+'/conference-london/vedio')
                    .then(function(res) {
            ...
            getTime() {
                let that = this;
                this.$http.get(api+'/conference-london/conference')
                    .then(function(res) {
            ...
            getPlau() {
                let that = this;
                this.$http.get(api+'/conference-london/agenda')
                    .then(function(res) {
            ...
            getSpeaker() {
                let that = this;
                this.$http.get(api+'/conference-london/speaker')
                    .then(function(res) {
