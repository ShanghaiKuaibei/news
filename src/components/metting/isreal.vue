...
<script>
    ...
    export default {
        ...
        methods: {
            getImgUrl() {
                let that = this;
                this.$http.get(api+'/conference-israel/detail')
                    .then(function(res) {
            ...
            getUrl() {
                let that = this;
                this.$http.get(api+'/conference-israel/vedio')
                    .then(function(res) {
            ...
            showFooter() {
                this.$store.commit("toShow");
            },
            hideFooter() {
                this.$store.commit("toHide");
            },
            register() {
            ...
            getTime() {
                let that = this;
                this.$http.get(api+'/conference-israel/conference')
                    .then(function(res) {
            ...
            getProject() {
                let that = this;
                this.$http.get(api+'/conference-israel/project')
                    .then(function(res) {
            ...
            getPlau() {
                let that = this;
                this.$http.get(api+'/conference-israel/agenda')
                    .then(function(res) {
            ...
            getSpeaker() {
                let that = this;
                this.$http.get(api+'/conference-israel/speaker')
                    .then(function(res) {
